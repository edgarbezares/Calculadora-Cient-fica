...
///int x(posición horizontal),int y(posición vertical),nWidth (anchura),int nHeight(altura).
    ...
    tipos_conversion = CreateWindow("STATIC","Tipos de conversion",WS_CHILD | WS_VISIBLE | SS_NOTIFY | SS_CENTER,6,102,120,30,ventana,NULL,ins,NULL);
